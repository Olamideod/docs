...
Server authentication solves different problems than user authentication. Users have browsers and can click buttons that servers need automated, reliable authentication that works 24/7.
