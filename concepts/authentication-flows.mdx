...
description: "Understanding different authentication flows"
---
<Tip>
This Page explains how different authentication patterns work and when to use them.
</Tip>
...
Nearly everyone has used one, and nearly everyone assumes they all work the same way. But they don’t. Passwordless login, enterprise [SSO](/support/glossary#sso-single-sign-on), mobile apps, and API services each demand a different kind of flow.
...
[PKCE (Proof Key for Code Exchange)](/support/glossary#pkce-proof-key-for-code-exchange) is for applications that can't securely store secrets mobile apps and single-page applications.
...
[SAML (Security Assertion Markup Language)](/support/glossary#saml-security-assertion-markup-language) is how enterprises do single sign-on. When employees click "Sign in with Okta" or "Sign in with Azure AD," SAML handles it.

**How it works:**
1. User clicks SSO and gets Redirected to identity provider
